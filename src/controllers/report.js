...
export default class reportController {
  ...
  static async create ( req, res ) {
    ...
    try {
      ...
      if ( majorData.ratio.math.ga == 0 && score.math.type == "나") throw Error('MATH_GA_NOT_FOUND')
      else if ( majorData.ratio.math.na == 0 && score.math.type =="가") throw Error('MATH_NA_NOT_FOUND')
      else if ( majorData.ratio.tamgu.science == 0 && score.line == "인문") throw Error('SOCIETY_NOT_FOUND')
      else if ( majorData.ratio.tamgu.society == 0 && score.line == "자연") throw Error('SCIENCE_NOT_FOUND')
