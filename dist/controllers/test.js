    ...
    try {
      ...
      for (let i = 3; i < 5525; i++) {
        ...
        if (societyValue - societyAnswer <= 0) {
          if (societyValue - societyAnswer >= -3) societyDeterminant = 1;else societyDeterminant = 0;
        }
        ...
        if (scienceValue - scienceAnswer <= 0) {
          if (scienceValue - scienceAnswer >= -3) scienceDeterminant = 1;else scienceDeterminant = 0;
        }
