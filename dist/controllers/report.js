...
class reportController {
  ...
  static async getScore(score, majorData, create) {
    ...
    if (univName == "가야대") {
      ...
      newScore.foreign.score = score.foreign.percentile * perfectScore.tamgu / 100; // 창신대 , 창원대 예외처리 
        ...
        if (tamguTranslation == "탐구: D타입") {
          ...
          if (univName === "연세대") {
            if (majorData.major.line == "자연") {
              ...
              if (mathTransitionScore !== null) newScore.math = mathTransition * 1.5 / 900 * 1000;else newScore.math = score.math.score / 600 * 1000;
              ...
              if (mathTransitionScore !== null) newScore.math = mathTransition / 600 * 1000;else newScore.math = score.math.score / 600 * 1000;
          ...
          if (univName === "연세대(미래)" && majorName == "의예과") {
            newScore.korean = score.korean.score / 900 * 1000;
            if (mathTransitionScore !== null) newScore.math = mathTransition * 1.5 / 900 * 1000;else newScore.math = score.math.score * 1.5 / 900 * 1000;
            newScore.tamgu1.score = tamgu1Transition * 3 / 900 * 1000;
            newScore.tamgu2.score = tamgu2Transition * 3 / 900 * 1000;
          }
          ...
          if (univName == "고려대") {
            if (majorName == "사이버국방학과") {
              ...
              if (mathTransitionScore !== null) newScore.math = mathTransition * 1.2 / 640 * 800;else newScore.math = score.math.score * 1.2 / 640 * 800;
              ...
              if (mathTransitionScore !== null) newScore.math = mathTransition * 1.2 / 640 * 1000;else newScore.math = score.math.score * 1.2 / 640 * 1000;
    ...
    if (extraType == "% 가산") {
      ...
      if (extraPoint == "+ [ 수가 ( 개인 취득 표준점수 / 전국최고 표준점수 ) x 10 ]" && math_type == "가") {
        ...
        if (line == "자연") {
          ...
          if (tamgu1Score > tamgu2Score) extraScore.tamgu1 = tamgu1Score;else extraScore.tamgu2 = tamgu2Score;
        }
      ...
      if (univName == "광주과학기술원") {
        for (let i = 0; i < 2; i++) {
          ...
          if (tamguName.indexOf("1") >= 0) {
            if (tamguGrade >= 3 && tamguGrade <= 4) tamgu1Minus = 3;else if (tamguGrade >= 5 && tamguGrade <= 6) tamgu1Minus = 4;else if (tamguGrade >= 7 && tamguGrade <= 8) tamgu1Minus = 5;else if (tamguGrade == 9) tamgu1Minus = 6;
          } else if (tamguName.indexOf("2") <= 0) {
            if (tamguGrade >= 4 && tamguGrade <= 5) tamgu1Minus = 2;else if (tamguGrade >= 6 && tamguGrade <= 7) tamgu1Minus = 3;else if (tamguGrade >= 8 && tamguGrade <= 9) tamgu1Minus = 4;
          }
        }
      }
    ...
    else if (reflectionSubject == "( 국, 수가나 우수영역 순서대로 40% + 20% ) + 영 25% + 탐 15%") {} else if (reflectionSubject == "우수영역 순서대로 45% + 40% + 15%") {
    ...
    console.log(totalSum); // if ( univName == "대구교대") throw Error('SCORE_NOT_FOUND')
  ...
  static async getScoreByGrade(score, majorData) {
    ...
    if (univName.indexOf("경동대") >= 0) {
      ...
      if (majorData.major.group == "가") {
        ...
        historyScore = 45;
        if (score.history.grade > 4 && score.history.grade < 8) historyScore = 44;else if (score.history.grade > 7) historyScore = 43;
        ...
        historyScore = 50;
        if (score.history.grade > 4 && score.history.grade < 8) historyScore = 49;else if (score.history.grade > 7) historyScore = 48;
      ...
      if (score.korean.grade == 1) koreanScore = 30;else if (score.korean.grade == 2) koreanScore = 29.1;else koreanScore = 29.1 - (score.korean.grade - 2) * 1.5;
