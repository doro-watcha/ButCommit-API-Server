...
class reportController {
  ...
  static async getScore(score, majorData, create) {
    ...
    var naesinScore = 0.0;
    console.log("내신점수" + score.naesinScore);
    console.log("내신 ratio" + majorData.metadata.naesinRatio);

    if (score.naesinScore != 0 && isNaN(majorData.metadata.naesinRatio) == false) {
      let naesin = await _services.naesinService.findOne(majorData.major.univName, majorData.major.recruitmentType, majorData.major.recruitmentUnit, majorData.major.sosokUniversity, majorData.major.majorName, score.naesinType, score.naesinScore);
      console.log(naesin);
